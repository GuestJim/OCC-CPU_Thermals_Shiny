...
TSERIEStabUI	<-	function(id, SHOW = TRUE, BRUSH = TRUE, ..., label = "Time Series UI")	{
	...
	tabPanel("Time Series",
		tagList(
			tabsetPanel(
				tabPanel("Temperature",
					plotOutput('timeTEMPtrend',	height=720,	dblclick	=	ifBRUSH("brushTIMEtempTRENDdbl"),
						brush	=	ifBRUSH(brushOpts(id	=	"brushTIMEtempTREND", resetOnNew	=	TRUE, direction	=	"x"))),
					plotOutput('timeTEMPseas',	height=720,	dblclick	=	ifBRUSH("brushTIMEtempSEASdbl"),
						brush	=	ifBRUSH(brushOpts(id	=	"brushTIMEtempSEAS", resetOnNew	=	TRUE, direction	=	"x"))),
				),
				tabPanel("Frequency",
					plotOutput('timeFREQtrend',	height=720,	dblclick	=	ifBRUSH("brushTIMEfreqTRENDdbl"),
						brush	=	ifBRUSH(brushOpts(id	=	"brushTIMEfreqTREND", resetOnNew	=	TRUE, direction	=	"x"))),
					plotOutput('timeFREQseas',	height=720,	dblclick	=	ifBRUSH("brushTIMEfreqSEASdbl"),
						brush	=	ifBRUSH(brushOpts(id	=	"brushTIMEfreqSEAS", resetOnNew	=	TRUE, direction	=	"x"))),
				),
				tabPanel("Socket Power",
					plotOutput('timeSOCKtrend',	height=720,	dblclick	=	ifBRUSH("brushTIMEsockTRENDdbl"),
						brush	=	ifBRUSH(brushOpts(id	=	"brushTIMEsockTREND", resetOnNew	=	TRUE, direction	=	"x"))),
					plotOutput('timeSOCKseas',	height=720,	dblclick	=	ifBRUSH("brushTIMEsockSEASdbl"),
						brush	=	ifBRUSH(brushOpts(id	=	"brushTIMEsockSEAS", resetOnNew	=	TRUE, direction	=	"x"))),
				),
				tabPanel("Core Power",
					plotOutput('timeCOREtrend',	height=720,	dblclick	=	ifBRUSH("brushTIMEcoreTRENDdbl"),
						brush	=	ifBRUSH(brushOpts(id	=	"brushTIMEcoreTREND", resetOnNew	=	TRUE, direction	=	"x"))),
					plotOutput('timeCOREseas',	height=720,	dblclick	=	ifBRUSH("brushTIMEcoreSEASdbl"),
